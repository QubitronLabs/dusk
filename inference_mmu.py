...
if __name__ == '__main__':
    ...
    if mmu_model_path is None:
        mmu_model_path = config.model.dusk.pretrained_model_path
    ...
    model = DuskModelLM.from_pretrained(mmu_model_path, trust_remote_code=True, torch_dtype=torch.bfloat16).to(device)
    model.eval()
