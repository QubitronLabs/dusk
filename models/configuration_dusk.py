...
class DuskBaseConfig(PretrainedConfig):
    model_type = "dusk_base"
    ...
    def __init__(self, use_cache: bool = False, **kwargs):
        ...
        all_kwargs.update(
            {
                "architectures": all_kwargs.get("architectures", ["DuskBaseLM"])
            }
        )
...
AutoConfig.register("dusk_base", DuskBaseConfig)
