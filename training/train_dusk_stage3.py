...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(config.model.dusk.tokenizer_path, padding_side="left")
    ...
    model = DuskModelLM.from_pretrained(config.model.dusk.pretrained_model_path, torch_dtype=torch.bfloat16).to(accelerator.device)
...
def visualize_predictions(
    ...
    # mask_token_id = config.model.dusk.vocab_size - 1 - len(uni_prompting.text_tokenizer)
