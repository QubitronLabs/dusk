...
@register_model("dusk_dist")
class DuskEvalHarness(LM):
    def __init__(
        self,
        model_path='',
        mask_id=126336,
        ...
        **kwargs,
        ...
        '''
        Args:
            model_path: Dusk-8B-Base model path.
            ...
            is_check_greedy: For certain metrics like LAMBADA, the evaluation requires the model to verify whether the answer 
                             ...
                             However, since none of the metrics in the Dusk paper (https://arxiv.org/abs/2502.09992) require this functionality, 
